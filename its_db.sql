...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2024 at 04:19 AM
...
INSERT INTO `tbl_bill` (`bill_id`, `bill_no`, `bill_img`, `bill_date`, `inventory_id`) VALUES
(8, '', '662cedd0c5079.png', '2024-04-26', 0),
(10, '', '663d09ef875f2.png', '2024-05-09', 0);
...
INSERT INTO `tbl_product` (`pid`, `barcode`, `product`, `category`, `supplier_name`, `description`, `stock`, `purchaseprice`, `saleprice`, `image`) VALUES
(1, '1125103', 'Laptop', 'Laptop', '', 'HP laptop 1st', 1000, 0, 70000, '662a05ce339f6.png'),
(5, '9788189955304', 'Living Frearlessly', 'Sakar Entreprise', '', ' Bringing Our Your inner Soul Strength', 100, 10000, 15000, '662f43e3e7983.jpg'),
(6, '8904103307580', 'GAS-O-FAST', 'Sakar Entreprise', '', 'Pet Safa  Har Roj Dafa', 1000, 12000, 13000, '662f444820a3e.png'),
(7, '864816062253053', 'Realm', 'Sakar Entreprise', '', 'Kuba Di Ka Phono', 10, 1500000, 2000000, '662f449962aae.jpeg'),
(8, '8062942', 'PAN', 'Deepesh', '', 'ADD PEN', 12, 1200, 1, '6638d43ea93f9.jpg'),
(9, '9063650', 'PROJECTOR', 'Deepesh', '', 'WASEDXCFGVBH NM', 456, 23456, 67899, '6638d5ea2d04a.jpg'),
(10, '10100124', 'Head Phone', 'Sakar Entreprise', '', 'jxhshfgdhegjle', 12, 1200, 0, '6639ae9c24065.jpeg'),
(11, '11101110', 'Ear Phone', 'Sakar Entreprise', '', 'werfghj', 500, 50000, 0, '6639b0e6a4b9a.png'),
(12, '12101327', 'fan', 'Sakar Entreprise', '', 'rwetywqeqw', 100, 1000, 0, '6639b16f8e9f3.png'),
(13, '13104104', 'pillow', 'Garvita', '', 'jbhhbj', 100, 1000, 0, '663d03a8155e9.jpg'),
(14, '14105451', 'pillow', 'Bhawana', '', 'rdfcgbhjk', 34, 78, 100, '663d06e3a3f22.jpg');
...
INSERT INTO `tbl_request` (`request_id`, `product`, `request_qty`, `request_date`, `requested_by`, `purpose`, `status`) VALUES
(5, 'Laptop', 10, '2024-04-26', 'Garvita', 'want laptop', 'requested'),
(6, 'Fan', 5, '2024-04-26', '', 'New request', 'requested'),
(7, 'PC', 20, '2024-04-26', '', 'For Lab 2', 'received'),
(8, 'Charger', 3, '2024-04-26', '', 'For charging', 'received'),
(9, 'Mobile', 30, '2024-04-26', '', 'for students', 'requested'),
(10, 'Projector', 10, '2024-04-26', 'user', 'New request', 'requested'),
(11, 'HP Laptop', 10, '2024-04-27', 'Admin', 'for students', 'requested'),
(12, 'CPU', 3, '2024-04-29', 'Deepesh', 'Need', 'requested'),
(13, 'CPU', 3, '2024-04-29', 'Deepesh', 'Need', 'requested'),
(14, 'Projector', 5, '2024-05-07', 'user', 'Need', 'requested'),
(15, 'CPU', 3, '2024-05-09', 'user', 'Need', 'requested');
...
INSERT INTO `tbl_supplier` (`supplier_id`, `supplier_name`, `supplier_email`, `supplier_phone`, `supplier_address`, `supplier_status`) VALUES
(1, 'Garvita', 'garvita@gmail.com', 1234567890, 'Shantipuram', 'Active'),
(3, 'Deepesh', 'deepesh@gmail.com', 1234567890, 'Naini', 'Active'),
(4, 'Bhawana', 'bhawana@gmail.com', 1234567890, 'Sonbhadra', 'Active'),
(5, 'Sakar Entreprise', 'sakar@gmail.com', 1234567890, 'Naini', 'Active');
...
CREATE TABLE `tbl_transfer` (
  ...
  `product` varchar(200) NOT NULL,
  `from_dept` varchar(200) NOT NULL,
  `to_dept` varchar(200) NOT NULL,
...
INSERT INTO `tbl_transfer` (`transfer_id`, `product`, `from_dept`, `to_dept`, `quantity`, `reason`, `requested_by`, `request_date`, `status`) VALUES
(1, 'Laptop', 'Department 1', 'Department 2', 10, 'required', 'Admin', '2024-04-28', 'Working'),
(2, 'Ear Phone', 'Information Technology', 'Civil', 22, 'dtfgyh', 'user', '2024-05-10', ''),
(3, 'Ear Phone', 'Electronic', 'Machanical', 12, 'please', 'Admin', '2024-05-10', '');
...
INSERT INTO `tbl_user` (`userid`, `username`, `useremail`, `userpassword`, `role`, `twitter`, `facebook`, `insta`, `linkedin`, `about`, `address`, `number`) VALUES
(1, 'Admin', 'admin@gmail.com', '12345', 'Admin', '', 'https://www.facebook.com/theugiindia', 'https://www.instagram.com/theugiindia/', 'https://www.linkedin.com/company/unitedgroupofinstitutions/?originalSubdomain=in', 'The United Group , founded by late Shri Shiv Ram Das Gulati in 1951 emerged from a transport business to the giants in the fields of education, services, transportation and journalism. The group made ', 'UPSIDC INDUSTRIAL AREA, NAINI, ALLAHABAD, U.P., 211010', 123456789),
(2, 'user', 'user@gmail.com', '123', 'User', '', 'https://www.facebook.com/theugiindia', 'https://www.instagram.com/theugiindia/', 'https://www.linkedin.com/company/unitedgroupofinstitutions/?originalSubdomain=in', 'The United Group , founded by late Shri Shiv Ram Das Gulati in 1951 emerged from a transport business to the giants in the fields of education, services, transportation and journalism.', 'UPSIDC INDUSTRIAL AREA, NAINI, ALLAHABAD, U.P., 211010', 123456789),
(15, 'Garvita', 'garvita@gmail.com', '123', 'User', '', '', '', '', '', '', 0),
(17, 'Bhawana', 'bhawana@gmail.com', '123', 'User', '', '', '', '', '', '', 0),
(20, 'Deepesh', 'deepesh@gmail.com', '123', 'User', '', '', '', '', '', '', 0),
(21, 'Test', 'test@gmail.com', '123', 'User', '', '', '', '', '', '', 0);
...
--
ALTER TABLE `tbl_taxdis`
  MODIFY `taxdis_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
